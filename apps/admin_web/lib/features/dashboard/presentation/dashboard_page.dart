...
class _DashboardPageState extends State<DashboardPage> {
  ...
  Future<void> _loadDashboardData() async {
    ...
    try {
      ...
      // Load active orders by checking status through best_kos_item_statusse
      final aktieweBestellingsData = await sb
          .from('bestelling')
          .select('''
            best_id,
            bestelling_kos_item!inner(
              best_kos_id,
              best_kos_item_statusse!inner(
                kos_item_statusse!inner(kos_stat_naam)
              )
            )
          ''')
          .inFilter('bestelling_kos_item.best_kos_item_statusse.kos_item_statusse.kos_stat_naam', ['Wag vir afhaal', 'In voorbereiding']);
